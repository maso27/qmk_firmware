...
Disconnect the first half, connect the second one and repeat the process.
    ...
    make sofle/keyhive:maso27_keyhive:avrdude-split-left
    make sofle/keyhive:maso27_keyhive:avrdude-split-right

    # for Elite C or DFU bootloader builds
    make sofle/keyhive:maso27_keyhive:dfu-split-left
    make sofle/keyhive:maso27_keyhive:dfu-split-right
