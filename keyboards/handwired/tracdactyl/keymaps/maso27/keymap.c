...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * '-----------------------------------------/                                  \-----------------------------------------'
   *               |CtlAlt|      |    /       /---------------.    .---------------\       \    |      |      |
   *               |  Del |      |   / RGBNxt/Layers /Shift- /      \       \ Layers\   _   \   |      |      |
   *               '-------------'  '-------/   OFF /  Del  /        \       \  OFF  \-------'  '-------------'
   *                                       /---------------/          \---------------\
   *                                      / MACRO /       /            \       \   _   \
   *                                     /  Stop /       /              \       \       \
...
*/
    ...
    const rgblight_segment_t PROGMEM my_layer2_layer[] = RGBLIGHT_LAYER_SEGMENTS(
      ...
      {24, 1,HSV_PURPLE}, // ctl-alt-del on windows key
      // {23}, 1,HSV_GREEN},  // R-ctrl on ctrl key
      {21,1,HSV_GREEN},  // real greaves key
      {20,1,HSV_RED},    // alt-F4 on Esc key
      {28,1,HSV_RED}     // macro_stop
    );
    const rgblight_segment_t PROGMEM my_layer3_layer[] = RGBLIGHT_LAYER_SEGMENTS(
      ...
      {13,1,HSV_GREEN},
      {9, 1,HSV_GREEN},
      {28,1,HSV_BLUE},   // macro_rec
      {2 ,1,HSV_RED},   // capslock
      {33,1,HSV_GREEN}, // enter (no shift)
      {35,2,HSV_RED},   // delete word and backspace
      {56,1,HSV_GREEN}, // ~
      {49,1,HSV_GREEN}, // home
      {41,1,HSV_GREEN}, // end
      {47,1,HSV_GREEN}, // prev_word
      {39,1,HSV_GREEN}, // next_word
      {51,2,HSV_GREEN}  // pgup-pgdn
    );
