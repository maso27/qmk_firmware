...
RGBLIGHT_ENABLE ?= no
VALID_RGBLIGHT_TYPES := WS2812 APA102 LPD8806 custom
...
ifeq ($(strip $(RGBLIGHT_ENABLE)), yes)
    ...
    ifeq ($(strip $(RGBLIGHT_DRIVER)), LPD8806)
        LPD8806_DRIVER_REQUIRED := yes
    endif
...
ifneq (,$(filter $(MCU), atmega16u2 atmega32u2 at90usb162))
    ...
    ifeq ($(strip $(RGB_MATRIX_DRIVER)), LPD8806)
        OPT_DEFS += -DLPD8806
        LPD8806_DRIVER_REQUIRED := yes
    endif
...
ifeq ($(strip $(LPD8806_DRIVER_REQUIRED)), yes)
    COMMON_VPATH += $(DRIVER_PATH)/led
    SRC += lpd8806.c
endif
